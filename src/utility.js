...
function getArgument() {
    ...
    if ( (param != APP_ONLY_PARAM) && (param != API_ONLY_PARAM)) {
        console.log("Invalid argument: " +
            "please pass one of the valid arugments: \'%s\' '%s\'", APP_ONLY_PARAM, API_ONLY_PARAM);
        process.exit(-1);
    }
 ...
 */
module.exports.API_ONLY_PARAM                               = API_ONLY_PARAM;
